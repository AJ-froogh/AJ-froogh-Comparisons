...
public class Comparators {
     ...
     */
    public boolean isEqual(int a, int b){if(a==b){return true;}
        return false;
    }
     ...
     */
    public boolean greaterThan(int a, int b){if(a>b){return true;}
        return false;
    }
    /**
     * @param a the first number to be compared.
     ...
     */
    public boolean lessThan(int a, int b){if(a<b){return true;}
        return false;
    }
    /**
     * @param a the first number to be compared.
     ...
     */
    public boolean greaterThanOrEqualTo(int a, int b){if((a>b)||(a==b)){return true;}else
        {return false;}
    }
    /**
     * @param a the first number to be compared.
     ...
     */
    public boolean lessThanOrEqualTo(int a, int b){if((a<b)||(a==b)){return true;}else
        {return false;}
    }
     ...
     */
    public boolean notEqualTo(int a, int b){if(a!=b){return true;}else
        {return false;}
    }
}